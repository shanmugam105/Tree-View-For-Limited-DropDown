...
@objc public class KJTree : NSObject {
    ...
    public init(parents: NSArray, childrenKey: String, expandableKey: String? = nil, key: String? = nil) {
        ...
        for i in 0..<parents.count {
            ...
            guard let parentConfirmed = parent else { continue }
            ...
            // check childs
            guard let childs = parentConfirmed.object(forKey: childrenKey) as? NSArray, childs.count != 0
            else {
            ...
            } else if let expanded = parentConfirmed.object(forKey: expandableKey ?? "") as? String,
                      expanded.lowercased() == "true" {
                parentInstance.isVisibility = true
            }
    ...
    public func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> NSInteger {
        ...
        for i in 0..<arrayParents.count {
            ...
            var currentState: CellState = .none // CellState decision open, close or none.
...
@objc public class Node: NSObject {
    ...
    // public instances
    public var state: CellState = .none
